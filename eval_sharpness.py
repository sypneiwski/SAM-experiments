...
def evaluate_hessian_sharpness(model, train_dataset, criterion, use_gpu=False):
    """
    ...
    eigenvals, _ = compute_hessian_eigenthings(model, train_loader, criterion, 1, use_gpu=use_gpu)
    return eigenvals[0]
